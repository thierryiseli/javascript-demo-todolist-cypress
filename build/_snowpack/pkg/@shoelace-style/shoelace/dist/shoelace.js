import { w as watchIcon, u as unwatchIcon, g as getIconLibrary } from '../../../common/chunk.L23EKU34-a7b8d25a.js';
export { a as getBasePath, r as registerIconLibrary, s as setBasePath, b as unregisterIconLibrary } from '../../../common/chunk.L23EKU34-a7b8d25a.js';
...
var M = (t4, i5) => {
  ...
  for (let i6 = 0; i6 < s5; i6++) {
    ...
    h4 += u3 === f ? s6 + r : d2 >= 0 ? (e6.push(l4), s6.slice(0, d2) + "$lit$" + s6.slice(d2) + n + a4) : s6 + n + (d2 === -2 ? (e6.push(void 0), i6) : a4);
  }
...
var H = class {
  ...
  I(t4, i5 = this, s5, e6) {
    ...
    let l4 = false;
    if (o7 === void 0)
      t4 = S(this, t4, i5, 0), l4 = !d(t4) || t4 !== this.H && t4 !== w, l4 && (this.H = t4);
    else {
      const e7 = t4;
      let n7, h4;
      for (t4 = o7[0], n7 = 0; n7 < o7.length - 1; n7++)
        h4 = S(this, e7[s5 + n7], i5, n7), h4 === w && (h4 = this.H[n7]), l4 || (l4 = !d(h4) || h4 !== this.H[n7]), h4 === A ? t4 = A : t4 !== A && (t4 += (h4 != null ? h4 : "") + o7[n7 + 1]), this.H[n7] = h4;
    }
    l4 && !e6 && this.W(t4);
  }
  W(t4) {
...
(i$1 = (t$1 = globalThis).litHtmlPlatformSupport) === null || i$1 === void 0 || i$1.call(t$1, N, C), ((s$1 = (e = globalThis).litHtmlVersions) !== null && s$1 !== void 0 ? s$1 : e.litHtmlVersions = []).push("2.0.0-rc.3");
...
var o2 = (t4) => {
  let o7 = n2.get(t4);
  return o7 === void 0 && n2.set(t4, o7 = new s2(t4, e2)), o7;
};
...
var u2 = t2 ? (t4) => t4 : (t4) => t4 instanceof CSSStyleSheet ? ((t5) => {
  let e6 = "";
...
var d$1 = (o) => o.strings === void 0;
var s2$1 = {};
var f$1 = (o, t2 = s2$1) => o.H = t2;

// node_modules/lit-html/directives/live.js
var l$2 = i(class extends s {
  constructor(r) {
...
var responsive_media_styles_default = i2`
  ${component_styles_default}
...
var SlSelect = class extends h3 {
  constructor() {
    super(...arguments);
    this.inputId = `select-${++id$3}`;
    this.helpTextId = `select-help-text-${id$3}`;
    this.labelId = `select-label-${id$3}`;
    this.hasFocus = false;
    this.hasHelpTextSlot = false;
    this.hasLabelSlot = false;
    this.isOpen = false;
...
var skeleton_styles_default = i2`
  ${component_styles_default}
...
var menu_label_styles_default = i2`
  ${component_styles_default}
...
var progress_bar_styles_default = i2`
  ${component_styles_default}
...
var SlProgressBar = class extends h3 {
  ...
  render() {
    return T`
      ...
      >
        <div part="indicator" class="progress-bar__indicator" style=${i2$1({ width: this.percentage + "%" })}>
...
var progress_ring_styles_default = i2`
  ${component_styles_default}
...
var SlRange = class extends h3 {
  constructor() {
    super(...arguments);
    this.inputId = `input-${++id$7}`;
    this.helpTextId = `input-help-text-${id$7}`;
    this.labelId = `input-label-${id$7}`;
    this.hasFocus = false;
    this.hasHelpTextSlot = false;
    this.hasLabelSlot = false;
...
n2$1.directiveName = "unsafeHTML", n2$1.resultType = 1;
var o$1 = i(n2$1);

// node_modules/lit-html/directives/unsafe-svg.js
var t2$1 = class extends n2$1 {
};
t2$1.directiveName = "unsafeSVG", t2$1.resultType = 2;
var o2$1 = i(t2$1);
...
var SlIcon = class extends h3 {
  ...
  render() {
    return T` <div part="base" class="icon" role="img" aria-label=${this.getLabel()}>${o2$1(this.svg)}</div>`;
  }
};
...
var image_comparer_styles_default = i2`
  ${component_styles_default}
      ...
      <div part="base" class="image-comparer" @keydown=${this.handleKeyDown}>
        <div class="image-comparer__image">
          ...
          <div
            ...
            style=${i2$1({ clipPath: `inset(0 ${100 - this.position}% 0 0)` })}
          >
...
var menu_divider_styles_default = i2`
  ${component_styles_default}
...
var SlCheckbox = class extends h3 {
  constructor() {
    super(...arguments);
    this.inputId = `checkbox-${++id$8}`;
    this.labelId = `checkbox-label-${id$8}`;
    this.hasFocus = false;
    this.disabled = false;
    this.required = false;
    this.checked = false;
      ...
      >
        <span part="control" class="checkbox__control">
          ...
          <input
            ...
            name=${l$1(this.name)}
            value=${l$1(this.value)}
            .indeterminate=${l$2(this.indeterminate)}
            .checked=${l$2(this.checked)}
            .disabled=${this.disabled}
            .required=${this.required}
            role="checkbox"
...
var color_picker_styles_default = i2`
  ${component_styles_default}
...
var SlDropdown = class extends h3 {
  constructor() {
    super(...arguments);
    this.componentId = `dropdown-${++id$d}`;
    this.open = false;
...
var animation_styles_default = i2`
  ${component_styles_default}
...
export { alert_default as SlAlert, animation_default as SlAnimation, avatar_default as SlAvatar, badge_default as SlBadge, button_default as SlButton, button_group_default as SlButtonGroup, card_default as SlCard, checkbox_default as SlCheckbox, color_picker_default as SlColorPicker, details_default as SlDetails, dialog_default as SlDialog, drawer_default as SlDrawer, dropdown_default as SlDropdown, form_default as SlForm, format_bytes_default as SlFormatBytes, format_date_default as SlFormatDate, format_number_default as SlFormatNumber, icon_default as SlIcon, icon_button_default as SlIconButton, image_comparer_default as SlImageComparer, include_default as SlInclude, input_default as SlInput, menu_default as SlMenu, menu_divider_default as SlMenuDivider, menu_item_default as SlMenuItem, menu_label_default as SlMenuLabel, progress_bar_default as SlProgressBar, progress_ring_default as SlProgressRing, qr_code_default as SlQrCode, radio_default as SlRadio, radio_group_default as SlRadioGroup, range_default as SlRange, rating_default as SlRating, relative_time_default as SlRelativeTime, resize_observer_default as SlResizeObserver, responsive_media_default as SlResponsiveMedia, select_default as SlSelect, skeleton_default as SlSkeleton, spinner_default as SlSpinner, switch_default as SlSwitch, tab_default as SlTab, tab_group_default as SlTabGroup, tab_panel_default as SlTabPanel, tag_default as SlTag, textarea_default as SlTextarea, tooltip_default as SlTooltip, getAnimationNames, getEasingNames };
